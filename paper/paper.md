...
4. **Visualization and Output**:
   - The `plots` module includes tools for creating interactive visualizations. For example, `interactive_plot`, which allows one to explore detected periodicities across bands and objects. For large datasets, `interactive_plot_large_files` enables in-depth inspection of signal consistency.
